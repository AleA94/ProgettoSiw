...
<body>
	...
	<div class="container tile navTop">
		<c:choose>
										...
										<c:choose>
											<c:when test="${i.prodotto.inAsta==0}">
												<div class="details col-md-8">
													...
													<div class="action">
														<p>
															<input class="add-to-cart btn btn-default"
																on="${i.idProdotto}" type="submit"
																value="Aggiungi al Carrello" />
														</p>
														<p>
															<input class="buy-now btn btn-default"
																on="${i.idProdotto}" type="submit"
																value="Compralo Subito" />
														</p>
														<p>
															<input class="add-to-wish btn btn-default"
																on="${i.idProdotto}" type="submit"
											...
											<c:when test="${i.prodotto.inAsta==1}">
												<div class="details col-md-6">
													...
													<h4 class="price">
														Data Inizio: <span>${i.dataInizio}</span>
													</h4>
													<h4 class="price">
														Data Fine: <span>${i.dataFine}</span>
													</h4>
													<h4 class="price">
													...
													<div class="action">
														<p>
															<button id="faiUnOfferta" on="${i.idAsta}"
			...
			<c:otherwise>
				<center>
					<h1>nessun prodotto presente per i correnti parametri di
						ricerca</h1>
				</center>
			</c:otherwise>
		</c:choose>
