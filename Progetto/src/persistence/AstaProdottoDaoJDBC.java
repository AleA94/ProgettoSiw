...
public class AstaProdottoDaoJDBC implements AstaProdottoDAO {
	...
	public List<AstaProdotto> getAste(int giorni, int ore) {
		...
		try {
			...
			String queryScadenzaOggi = "SELECT Nome,Descrizione,prezzoCorrente FROM asta , Prodotto where asta.id_prodotto=Prodotto.idProdotto and data_fine>=current_date()  and data_fine<current_date()+"
